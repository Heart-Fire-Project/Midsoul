...
execute if score $state data matches 3..4 run tellraw @s[team=guardian] [{text:"» ",bold:true,color:"red"},{translate:"ms.info.mid_guar",fallback:"游戏仍未结束，你可以继续进行游戏！",bold:false}]
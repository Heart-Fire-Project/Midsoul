...
tellraw @s[scores={skill=2}] [{translate:"ms.skill.102.desc",fallback:"获得伤害加成；标记最近的灵魂并持续发射粒子追踪其位置"},"\n",{translate:"ms.skill.102.desc.sub",fallback:"粒子仅你可见",color:"gray"}]

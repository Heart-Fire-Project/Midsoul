...
tellraw @s[scores={relic=8}] [{translate:"ms.relic",fallback:"[宝物] ",color:"#33FFAA"},{translate:"ms.relic.8",fallback:"投石成绊"}]
...
tellraw @s[scores={relic=8}] [{text:"> ",color:"#33FFAA"},{translate:"ms.tag.debuff",fallback:"妨害"}]

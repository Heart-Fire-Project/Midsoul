...
execute if score @s tick.relic matches 0.. run tag @s add item_on
...
execute if score @s tick.relic matches -3900..-1 run scoreboard players set @s item 0
execute if score @s tick.relic matches -3900..-1 run tag @s remove item_on

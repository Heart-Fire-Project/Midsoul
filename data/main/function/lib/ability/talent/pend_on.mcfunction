...
$execute if entity @a[team=guardian,distance=..12] as @s[team=soul,scores={talent_$(num)=2,tick.talent_$(num)=0}] run function main:lib/ability/talent/002
...
$execute if entity @s[team=guardian,scores={talent_$(num)=5,tick.talent_$(num)=0}] run function main:lib/ability/talent/105

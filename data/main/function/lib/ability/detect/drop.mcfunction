# 按照选中的格子判定触发的是哪种能力
execute if entity @s[team=soul,scores={relic=7},nbt={SelectedItemSlot:1}] unless entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{id:73007}}}}] at @s run function main:lib/ability/relic/discard

...
execute if score $map data matches 4 run data merge storage ms:temp {shard_goal:30,shard_summon:36,chest_summon:5,chest_max:15,size:3,complex:3,forceload1:"2031 1972 1877 2125",forceload2:"",forceload3:"",center:"2000 68 2000"}

...
execute if score $map data matches 3 run data merge storage ms:temp {shard_goal:40,shard_summon:44,chest_summon:6,chest_max:15,size:4,size_plus:true,complex:3,complex_plus:true,forceload1:"-1000 1000 -669 1160",forceload2:"-1000 1160 -669 1321",forceload3:"",center:"-819 1 1131"}
execute if score $map data matches 4 run data merge storage ms:temp {shard_goal:30,shard_summon:32,chest_summon:5,chest_max:14,size:2,size_plus:true,complex:2,complex_plus:true,forceload1:"2031 1972 1877 2125",forceload2:"",forceload3:"",center:"2000 68 2000"}

...
execute if score $map data matches 4 run data merge storage ms:temp {shard_goal:25,shard_summon:27,chest_summon:5,chest_max:14,size:2,size_plus:true,complex:2,complex_plus:true,forceload1:"2031 1972 1877 2125",forceload2:"",forceload3:"",center:"2000 68 2000"}

...
execute if score $map data matches 1 run data merge storage ms:temp {shard_goal:24,shard_summon:30,chest_summon:5,chest_max:14,size:3,complex:2,forceload1:"1000 1000 1110 1352",forceload2:"1110 1000 1220 1352",forceload3:""}
execute if score $map data matches 2 run data merge storage ms:temp {shard_goal:18,shard_summon:21,chest_summon:4,chest_max:10,size:2,complex:4,forceload1:"900 -900 1100 -1100",forceload2:"",forceload3:""}
execute if score $map data matches 3 run data merge storage ms:temp {shard_goal:40,shard_summon:48,chest_summon:6,chest_max:15,size:5,complex:3,forceload1:"-1000 1000 -669 1160",forceload2:"-1000 1160 -669 1321",forceload3:""}

...
tellraw @s[scores={temp=1}] ["",{translate:"ms.notice.1.1",fallback:"[QQ 群]",color:"#FFA488",click_event:{action:"open_url",url:"https://qm.qq.com/q/uQYzfFVcL6"}}," ",{translate:"ms.notice.1.2",fallback:"[Discord]",color:"#0066FF",click_event:{action:"open_url",url:"https://discord.gg/jxUxX283Jd"}}," ",{translate:"ms.notice.1.3",fallback:"[Github]",color:"#7B63AB",click_event:{action:"open_url",url:"https://github.com/Heart-Fire-Project/Midsoul"}}," ",{translate:"ms.notice.1.4",fallback:"[官网]",color:"#FFDD55",click_event:{action:"open_url",url:"https://hfpro.top/"}}]
...
tellraw @s[scores={temp=2}] ["",{translate:"ms.notice.2.1",fallback:"欢迎来到午夜灵魂 2.0：回响纪元！本次更新在升级至新版本的同时还新增了回响机制，此外还有大量的调整和优化……查看完整更新日志来了解更多！"},"\n",{translate:"ms.notice.2.2",fallback:"[查看完整更新日志]",click_event:{action:"open_url",url:"https://github.com/Heart-Fire-Project/Midsoul/blob/plus/changelog.md"}}]

...
execute if score $mode setting matches 1 run data merge storage ms:mode {start:"5",cancel:"4",logic:"1",rating:"1",role:"1",affact_rating:true,affact_exp:true,affact_data:true}
...
execute if score $mode setting matches 2 run data merge storage ms:mode {start:"2",cancel:"1",logic:"1",rating:"1",role:"1",affact_rating:false,affact_exp:false,affact_data:false}
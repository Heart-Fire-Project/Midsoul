tellraw @s[tag=no_hit] [{text:" +200 | ",color:"#8A6EDB"},{translate:"ms.rating.revive.s",fallback:"完美复活"}]
execute unless score @s temp.dying matches -2147483648..2147483647 run tellraw @s[tag=!no_hit] [{text:" +180 | ",color:"#8A6EDB"},{translate:"ms.rating.revive.a",fallback:"不屈复活"}]

...
execute as @e[tag=blue,scores={tick.general=-6}] run data merge entity @s {Glowing:0b}
scoreboard players reset @e[tag=blue,scores={tick.general=..-6}] tick.general
...
kill @e[tag=tracker,scores={tick.general=..-5}]

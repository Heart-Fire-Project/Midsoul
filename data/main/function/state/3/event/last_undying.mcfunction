# 颜色变化
scoreboard players add $3_lasthope_color tick.general 1
execute if score $3_lasthope_color tick.general matches 10 run scoreboard players set $3_lasthope_color tick.general -8
scoreboard players operation $color temp = $3_lasthope_color tick.general

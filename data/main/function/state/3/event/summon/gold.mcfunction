...
# 至少得到一个点位，进行生成
execute at @e[tag=gold_select] run summon block_display ~ ~ ~ {Tags:[game_entity,new_gold,gold],Glowing:1b,block_state:{Name:soul_lantern},transformation:{scale:[1.4f,1.4f,1.4f],translation:[-0.7f,0f,-0.7f],right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f]},Rotation:[0f,0f]}

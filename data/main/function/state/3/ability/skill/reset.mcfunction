...
scoreboard players set @s[team=soul,scores={skill=4}] tick.skill 120000
...
scoreboard players set @s[team=guardian,scores={skill=2}] tick.skill 130000
scoreboard players set @s[team=guardian,scores={skill=3}] tick.skill 120000
scoreboard players set @s[team=guardian,scores={skill=4}] tick.skill 120000
scoreboard players set @s[team=guardian,scores={skill=5}] tick.skill 150000
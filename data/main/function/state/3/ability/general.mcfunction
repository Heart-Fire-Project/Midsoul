...
execute as @a[team=soul,tag=T004,scores={talent_1=4,tick.talent_1=0,health=..19}] at @s run function main:state/3/ability/talent/004
execute as @a[team=soul,tag=T004,scores={talent_2=4,tick.talent_2=0,health=..19}] at @s run function main:state/3/ability/talent/004

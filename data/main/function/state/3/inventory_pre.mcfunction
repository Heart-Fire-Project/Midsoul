...
execute if entity @s[team=soul,scores={talent_1=4},tag=talent_1_on] run data modify storage ms:inventory T004 set value 1s
execute if entity @s[team=soul,scores={talent_2=4},tag=talent_2_on] run data modify storage ms:inventory T004 set value 1s

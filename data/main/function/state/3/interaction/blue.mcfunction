...
execute if score $aura_rank data matches 1 at @a[tag=interact_fin] as @e[tag=blue,distance=..8] run function main:lib/event/aura/1
execute if score $aura_rank data matches 2 at @a[tag=interact_fin] as @e[tag=blue,distance=..12] run function main:lib/event/aura/1

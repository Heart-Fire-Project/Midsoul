# 样式处理
execute if score $mode setting matches 1 if score $3_process countdown matches ..18000 run function main:state/3/bossbar/1/normal with storage ms:map
execute if score $mode setting matches 1 if score $3_process countdown matches 18001 run function main:state/3/bossbar/1/change
execute if score $mode setting matches 1 if score $3_process countdown matches 18001.. run function main:state/3/bossbar/1/emerge

...
# 设置数值 | single
execute store result bossbar midsoul:2 value run scoreboard players get $1_single tick.global
execute store result bossbar midsoul:3 value run scoreboard players get $1_single tick.global
...
# 设置开始闪烁 | max - single
scoreboard players operation $value temp = $1_max tick.global
scoreboard players operation $value temp -= $1_single tick.global
...
# 设置结束闪烁 | single
execute if score $1_single tick.global matches 4 run bossbar set midsoul:2 name ""
execute if score $1_single tick.global matches 3 run bossbar set midsoul:2 name {"translate":"ms.bossbar.1.select","fallback":"正在进行 » %s « 能力选择","color":"#52E5E7","with":[{"score":{"objective":"temp2","name":"$sec"}}]}
execute if score $1_single tick.global matches 2 run bossbar set midsoul:2 name ""
execute if score $1_single tick.global matches 1 run bossbar set midsoul:2 name {"translate":"ms.bossbar.1.select","fallback":"正在进行 » %s « 能力选择","color":"#52E5E7","with":[{"score":{"objective":"temp2","name":"$sec"}}]}
execute if score $1_single tick.global matches 4 run bossbar set midsoul:3 name ""
execute if score $1_single tick.global matches 3 run bossbar set midsoul:3 name {"translate":"ms.bossbar.1.select","fallback":"正在进行 » %s « 能力选择","color":"red","with":[{"score":{"objective":"temp2","name":"$sec"}}]}
execute if score $1_single tick.global matches 2 run bossbar set midsoul:3 name ""
execute if score $1_single tick.global matches 1 run bossbar set midsoul:3 name {"translate":"ms.bossbar.1.select","fallback":"正在进行 » %s « 能力选择","color":"red","with":[{"score":{"objective":"temp2","name":"$sec"}}]}
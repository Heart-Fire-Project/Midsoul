...
execute if score @s stat.play matches 10.. run scoreboard players operation @s stat.rating *= #9 data
execute if score @s stat.play matches 10.. run scoreboard players operation @s stat.rating /= #10 data

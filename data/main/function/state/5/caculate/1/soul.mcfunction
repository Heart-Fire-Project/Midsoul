...
execute if score $sec temp2 matches ..9 run tellraw @s[scores={temp=..9}] [{translate:"ms.rating.survive",fallback:"存活时长",color:"#4B9F5D"}," | +",{text:"00",color:"#486241"},{score:{objective:"temp",name:"@s"}}," (00:0",{score:{objective:"temp2",name:"$sec"}},")"]
execute if score $sec temp2 matches 10.. run tellraw @s[scores={temp=..9}] [{translate:"ms.rating.survive",fallback:"存活时长",color:"#4B9F5D"}," | +",{text:"00",color:"#486241"},{score:{objective:"temp",name:"@s"}}," (00:",{score:{objective:"temp2",name:"$sec"}},")"]
execute if score $sec temp2 matches ..9 run tellraw @s[scores={temp=10..99}] [{translate:"ms.rating.survive",fallback:"存活时长",color:"#4B9F5D"}," | +",{text:"0",color:"#486241"},{score:{objective:"temp",name:"@s"}}," (0",{score:{objective:"temp2",name:"$min"}},":0",{score:{objective:"temp2",name:"$sec"}},")"]
execute if score $sec temp2 matches 10.. run tellraw @s[scores={temp=10..99}] [{translate:"ms.rating.survive",fallback:"存活时长",color:"#4B9F5D"}," | +",{text:"0",color:"#486241"},{score:{objective:"temp",name:"@s"}}," (0",{score:{objective:"temp2",name:"$min"}},":",{score:{objective:"temp2",name:"$sec"}},")"]
execute if score $min temp2 matches ..9 if score $sec temp2 matches ..9 run tellraw @s[scores={temp=100..}] [{translate:"ms.rating.survive",fallback:"存活时长",color:"#4B9F5D"}," | +",{score:{objective:"temp",name:"@s"}}," (0",{score:{objective:"temp2",name:"$min"}},":0",{score:{objective:"temp2",name:"$sec"}},")"]
execute if score $min temp2 matches ..9 if score $sec temp2 matches 10.. run tellraw @s[scores={temp=100..}] [{translate:"ms.rating.survive",fallback:"存活时长",color:"#4B9F5D"}," | +",{score:{objective:"temp",name:"@s"}}," (0",{score:{objective:"temp2",name:"$min"}},":",{score:{objective:"temp2",name:"$sec"}},")"]
execute if score $min temp2 matches 10.. if score $sec temp2 matches ..9 run tellraw @s[scores={temp=100..}] [{translate:"ms.rating.survive",fallback:"存活时长",color:"#4B9F5D"}," | +",{score:{objective:"temp",name:"@s"}}," (",{score:{objective:"temp2",name:"$min"}},":0",{score:{objective:"temp2",name:"$sec"}},")"]
execute if score $min temp2 matches 10.. if score $sec temp2 matches 10.. run tellraw @s[scores={temp=100..}] [{translate:"ms.rating.survive",fallback:"存活时长",color:"#4B9F5D"}," | +",{score:{objective:"temp",name:"@s"}}," (",{score:{objective:"temp2",name:"$min"}},":",{score:{objective:"temp2",name:"$sec"}},")"]
scoreboard players operation @s exp.temp += @s temp
...
scoreboard players operation @s temp *= #65 data
scoreboard players add @s[scores={temp.heal=2..}] temp 40
scoreboard players add @s[scores={temp.heal=4..}] temp 60
tellraw @s[scores={temp=..9}] [{translate:"ms.rating.heal",fallback:"队友救助",color:"#EEC400"}," | +",{text:"00",color:"#7D623C"},{score:{objective:"temp",name:"@s"}}," (",{score:{objective:"temp.heal",name:"@s"}},"×)"]
tellraw @s[scores={temp=10..99}] [{translate:"ms.rating.heal",fallback:"队友救助",color:"#EEC400"}," | +",{text:"0",color:"#7D623C"},{score:{objective:"temp",name:"@s"}}," (",{score:{objective:"temp.heal",name:"@s"}},"×)"]
tellraw @s[scores={temp=100..}] [{translate:"ms.rating.heal",fallback:"队友救助",color:"#EEC400"}," | +",{score:{objective:"temp",name:"@s"}}," (",{score:{objective:"temp.heal",name:"@s"}},"×)"]
scoreboard players operation @s exp.temp += @s temp
...
scoreboard players add @s[scores={temp.tie=60..}] temp 25
scoreboard players add @s[scores={temp.tie=120..}] temp 45
tellraw @s[scores={temp=..9}] [{translate:"ms.rating.tie",fallback:"守卫牵制",color:"#F2850D"}," | +",{text:"00",color:"#7F4330"},{score:{objective:"temp",name:"@s"}}," (",{score:{objective:"temp.tie",name:"@s"}},"s)"]
tellraw @s[scores={temp=10..99}] [{translate:"ms.rating.tie",fallback:"守卫牵制",color:"#F2850D"}," | +",{text:"0",color:"#7F4330"},{score:{objective:"temp",name:"@s"}}," (",{score:{objective:"temp.tie",name:"@s"}},"s)"]
tellraw @s[scores={temp=100..}] [{translate:"ms.rating.tie",fallback:"守卫牵制",color:"#F2850D"}," | +",{score:{objective:"temp",name:"@s"}}," (",{score:{objective:"temp.tie",name:"@s"}},"s)"]
scoreboard players operation @s exp.temp += @s temp
...
scoreboard players add @s[team=revive,scores={temp.dying=0},tag=!no_hit] temp 160
scoreboard players add @s[team=revive,scores={temp.dying=1},tag=!no_hit] temp 125
scoreboard players add @s[team=revive,scores={temp.dying=2..},tag=!no_hit] temp 100
...
tellraw @s[scores={temp=..9}] [{translate:"ms.rating.general",fallback:"对局综合",color:"#DF6EA1"}," | +",{text:"00",color:"#8E5164"},{score:{objective:"temp",name:"@s"}}]
tellraw @s[scores={temp=10..99}] [{translate:"ms.rating.general",fallback:"对局综合",color:"#DF6EA1"}," | +",{text:"0",color:"#8E5164"},{score:{objective:"temp",name:"@s"}}]
tellraw @s[scores={temp=100..}] [{translate:"ms.rating.general",fallback:"对局综合",color:"#DF6EA1"}," | +",{score:{objective:"temp",name:"@s"}}]
scoreboard players operation @s exp.temp += @s temp

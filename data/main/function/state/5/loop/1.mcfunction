...
# 个人结算
execute if score $5_ending tick.general matches 115 as @a[team=revive] run function main:state/5/caculate/1/soul
execute if score $5_ending tick.general matches 115 as @a[team=dead] run function main:state/5/caculate/1/soul
execute if score $5_ending tick.general matches 115 as @a[team=soul] run function main:state/5/caculate/1/soul
execute if score $5_ending tick.general matches 115 as @a[team=guardian] run function main:state/5/caculate/1/guardian

# 短期分判定
execute if score $affact_rating data matches 0 run data merge storage ms:mode {affact_rating:false}
execute if score $5_ending tick.general matches 115 if data storage ms:mode {affact_rating:true} as @a[tag=game_player] run function main:state/5/rating
...
execute if score $5_ending tick.general matches 115 if data storage ms:mode {affact_data:true} as @a[tag=game_player] run function main:state/5/record

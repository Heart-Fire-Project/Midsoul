...
# 设置闪烁 - 剩余时间不足
execute if score $4_portal tick.general matches 603 run bossbar set midsoul:info visible false
execute if score $4_portal tick.general matches 602 run bossbar set midsoul:info visible true
execute if score $4_portal tick.general matches 601 run bossbar set midsoul:info visible false
execute if score $4_portal tick.general matches 600 run bossbar set midsoul:info visible true

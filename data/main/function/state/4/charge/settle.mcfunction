...
execute as @a[tag=interact_purple,tag=interacting,distance=..0.7] run scoreboard players add $num temp 1

# 效果结算
effect give @a[tag=interact_purple,tag=interacting,distance=..0.7] glowing 1

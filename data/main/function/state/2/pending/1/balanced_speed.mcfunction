...
execute unless score $balanced_speed state matches 0 unless score $collect_extend state matches 100 run playsound entity.villager.work_fletcher player @a 0 1000000 0 120000
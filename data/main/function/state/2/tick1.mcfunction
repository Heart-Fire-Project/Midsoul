...
# 多守卫判定
execute if score $2_starting tick.general matches 90 if data storage ms:mode {logic:"1"} run function main:state/2/pending/1/muiti_guardian

# 平衡性调速判定
execute if score $2_starting tick.general matches 75 if data storage ms:mode {logic:"1"} run function main:state/2/pending/1/balanced_speed

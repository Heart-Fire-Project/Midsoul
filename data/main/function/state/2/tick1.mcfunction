...
execute if score $2_starting tick.general matches 75 if score $value temp matches ..29 run scoreboard players set $balanced_speed state 35
execute if score $2_starting tick.general matches 75 if score $value temp matches 30..34 run scoreboard players set $balanced_speed state 20
...
execute if score $2_starting tick.general matches 75 run scoreboard players set $collect_extend state 100
execute if score $2_starting tick.general matches 75 run scoreboard players set $value temp 0
execute if score $2_starting tick.general matches 75 run scoreboard players operation $value temp = $soul_count data
execute if score $2_starting tick.general matches 75 run scoreboard players operation $value temp -= #4 data
execute if score $2_starting tick.general matches 75 run scoreboard players operation $value temp *= #10 data
execute if score $2_starting tick.general matches 75 if score $soul_count data matches 5.. run scoreboard players operation $collect_extend state -= $value temp
execute if score $2_starting tick.general matches 75 if score $balanced_speed state matches 1.. if score $collect_extend state matches 100 run tellraw @a [{text:"\n🔨 ",color:"#77E2F0"},{translate:"ms.info.balanced_speed",fallback:"平衡性交互调整"},"\n",{translate:"ms.info.balanced_speed.desc.a",fallback:"本局游戏中，灵魂的交互速率 %s%s%s",with:[{text:"+",color:"green"},{score:{name:"$balanced_speed",objective:"state"},color:"green"},{text:"%",color:"green"}],color:"white"}]
execute if score $2_starting tick.general matches 75 if score $balanced_speed state matches ..-1 if score $collect_extend state matches 100 run tellraw @a [{text:"\n🔨 ",color:"#77E2F0"},{translate:"ms.info.balanced_speed",fallback:"平衡性交互调整"},"\n",{translate:"ms.info.balanced_speed.desc.a",fallback:"本局游戏中，灵魂的交互速率 %s%s%s",with:["",{score:{name:"$balanced_speed",objective:"state"},color:"red"},{text:"%",color:"red"}],color:"white"}]
execute if score $2_starting tick.general matches 75 if score $balanced_speed state matches 0 if score $collect_extend state matches ..99 run tellraw @a [{text:"\n🔨 ",color:"#77E2F0"},{translate:"ms.info.balanced_speed",fallback:"平衡性交互调整"},"\n",{translate:"ms.info.balanced_speed.desc.b",fallback:"本局游戏中，灵魂的碎片收集速率降低至 %s%s",with:[{score:{name:"$collect_extend",objective:"state"},color:"red"},{text:"%",color:"red"}],color:"white"}]
execute if score $2_starting tick.general matches 75 if score $balanced_speed state matches 1.. if score $collect_extend state matches ..99 run tellraw @a [{text:"\n🔨 ",color:"#77E2F0"},{translate:"ms.info.balanced_speed",fallback:"平衡性交互调整"},"\n",{translate:"ms.info.balanced_speed.desc.c",fallback:"本局游戏中，灵魂的交互速率 %s%s%s；碎片收集速率降低至 %s%s",with:[{text:"+",color:"green"},{score:{name:"$balanced_speed",objective:"state"},color:"green"},{text:"%",color:"green"},{score:{name:"$collect_extend",objective:"state"},color:"red"},{text:"%",color:"red"}],color:"white"}]
execute if score $2_starting tick.general matches 75 if score $balanced_speed state matches ..-1 if score $collect_extend state matches ..99 run tellraw @a [{text:"\n🔨 ",color:"#77E2F0"},{translate:"ms.info.balanced_speed",fallback:"平衡性交互调整"},"\n",{translate:"ms.info.balanced_speed.desc.c",fallback:"本局游戏中，灵魂的交互速率 %s%s%s；碎片收集速率降低至 %s%s",with:["",{score:{name:"$balanced_speed",objective:"state"},color:"red"},{text:"%",color:"red"},{score:{name:"$collect_extend",objective:"state"},color:"red"},{text:"%",color:"red"}],color:"white"}]
execute if score $2_starting tick.general matches 75 unless score $balanced_speed state matches 0 unless score $collect_extend state matches 100 run playsound entity.villager.work_fletcher player @a 0 1000000 0 120000

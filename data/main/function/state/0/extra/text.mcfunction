...
# 解锁条件
tag @s[advancements={main:extra/text/0=true},scores={temp=0}] add can_equip
tag @s[advancements={main:extra/text/1=true},scores={temp=1}] add can_equip
tag @s[advancements={main:extra/text/2=true},scores={temp=2}] add can_equip
tag @s[advancements={main:extra/text/3=true},scores={temp=3}] add can_equip

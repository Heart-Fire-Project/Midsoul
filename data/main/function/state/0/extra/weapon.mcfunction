...
tellraw @s[tag=can_equip,scores={temp=3}] ["",{"text":"» ","color":"green","bold":true},{"translate":"ms.weapon","fallback":"武器样式"},{"translate":"ms.extra.switch","fallback":"已切换至 %s","with":[{"translate":"ms.weapon.3","fallback":"破魂砖","color":"green"}]}]

...
# 开始游戏倒计时
execute if data storage ms:setting {game_lock:true} run scoreboard players set $0_start tick.general 11
execute if score $0_start tick.general matches 1..10 run scoreboard players remove $0_start tick.general 1
...
execute if score $0_start tick.general matches 1..3 run playsound entity.arrow.hit_player player @a 0 1000000 0 120000 0.5

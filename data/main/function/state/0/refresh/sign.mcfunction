...
function base:merge_sign {x:"-2",y:"11",z:"-11",glow:"false",color:"orange",trans_2:"",trans_3:"",fallb_2:"?",fallb_3:"",command:"trigger detect.interact set 7001"}
...
execute if score $echo_page setting matches 1 if data storage ms:echo {"03":true} run function base:merge_sign {x:"-6",y:"6",z:"3",glow:"1",color:"green",trans_2:"",trans_3:"ms.echo.3",fallb_2:"03",fallb_3:"九次九碎片",command:"trigger detect.interact set 403"}
execute if score $echo_page setting matches 1 if data storage ms:echo {"03":false} run function base:merge_sign {x:"-6",y:"6",z:"3",glow:"1",color:"red",trans_2:"",trans_3:"ms.echo.3",fallb_2:"03",fallb_3:"九次九碎片",command:"trigger detect.interact set 403"}
execute if score $echo_page setting matches 1 if data storage ms:echo {"04":true} run function base:merge_sign {x:"-7",y:"6",z:"3",glow:"1",color:"green",trans_2:"",trans_3:"ms.echo.4",fallb_2:"04",fallb_3:"技能全靠盒",command:"trigger detect.interact set 404"}
execute if score $echo_page setting matches 1 if data storage ms:echo {"04":false} run function base:merge_sign {x:"-7",y:"6",z:"3",glow:"1",color:"red",trans_2:"",trans_3:"ms.echo.4",fallb_2:"04",fallb_3:"技能全靠盒",command:"trigger detect.interact set 404"}
execute if score $echo_page setting matches 1 if data storage ms:echo {"05":true} run function base:merge_sign {x:"-8",y:"6",z:"3",glow:"1",color:"green",trans_2:"",trans_3:"ms.echo.5",fallb_2:"05",fallb_3:"个雷劈落来",command:"trigger detect.interact set 405"}
execute if score $echo_page setting matches 1 if data storage ms:echo {"05":false} run function base:merge_sign {x:"-8",y:"6",z:"3",glow:"1",color:"red",trans_2:"",trans_3:"ms.echo.5",fallb_2:"05",fallb_3:"个雷劈落来",command:"trigger detect.interact set 405"}
execute if score $echo_page setting matches 2 if data storage ms:echo {"06":true} run function base:merge_sign {x:"-4",y:"6",z:"3",glow:"1",color:"green",trans_2:"",trans_3:"ms.echo.6",fallb_2:"06",fallb_3:"谁家小灵魂",command:"trigger detect.interact set 406"}
execute if score $echo_page setting matches 2 if data storage ms:echo {"06":false} run function base:merge_sign {x:"-4",y:"6",z:"3",glow:"1",color:"red",trans_2:"",trans_3:"ms.echo.6",fallb_2:"06",fallb_3:"谁家小灵魂",command:"trigger detect.interact set 406"}
execute if score $echo_page setting matches 2 if data storage ms:echo {"07":true} run function base:merge_sign {x:"-5",y:"6",z:"3",glow:"1",color:"green",trans_2:"",trans_3:"ms.echo.7",fallb_2:"07",fallb_3:"冲刺冲刺冲",command:"trigger detect.interact set 407"}
execute if score $echo_page setting matches 2 if data storage ms:echo {"07":false} run function base:merge_sign {x:"-5",y:"6",z:"3",glow:"1",color:"red",trans_2:"",trans_3:"ms.echo.7",fallb_2:"07",fallb_3:"冲刺冲刺冲",command:"trigger detect.interact set 407"}
execute if score $echo_page setting matches 2 if data storage ms:echo {"08":true} run function base:merge_sign {x:"-6",y:"6",z:"3",glow:"1",color:"green",trans_2:"",trans_3:"ms.echo.8",fallb_2:"08",fallb_3:"命运交响曲",command:"trigger detect.interact set 408"}
execute if score $echo_page setting matches 2 if data storage ms:echo {"08":false} run function base:merge_sign {x:"-6",y:"6",z:"3",glow:"1",color:"red",trans_2:"",trans_3:"ms.echo.8",fallb_2:"08",fallb_3:"命运交响曲",command:"trigger detect.interact set 408"}
execute if score $echo_page setting matches 2 if data storage ms:echo {"09":true} run function base:merge_sign {x:"-7",y:"6",z:"3",glow:"1",color:"green",trans_2:"",trans_3:"ms.echo.9",fallb_2:"09",fallb_3:"破门直接逃",command:"trigger detect.interact set 409"}
execute if score $echo_page setting matches 2 if data storage ms:echo {"09":false} run function base:merge_sign {x:"-7",y:"6",z:"3",glow:"1",color:"red",trans_2:"",trans_3:"ms.echo.9",fallb_2:"09",fallb_3:"破门直接逃",command:"trigger detect.interact set 409"}
...
# 能力分配
execute if score $ability_apply setting matches 0 run function base:merge_sign {x:"3",y:"6",z:"1",glow:"1",color:"light_gray",trans_2:"",trans_3:"ms.ability.0",fallb_2:"◆◇◇◇◇◇",fallb_3:"全部随机",command:"trigger detect.interact set 500"}
execute if score $ability_apply setting matches 1 run function base:merge_sign {x:"3",y:"6",z:"1",glow:"1",color:"green",trans_2:"",trans_3:"ms.ability.1",fallb_2:"◇◆◇◇◇◇",fallb_3:"仅自选技能",command:"trigger detect.interact set 500"}
execute if score $ability_apply setting matches 2 run function base:merge_sign {x:"3",y:"6",z:"1",glow:"1",color:"green",trans_2:"",trans_3:"ms.ability.2",fallb_2:"◇◇◆◇◇◇",fallb_3:"仅自选一天赋",command:"trigger detect.interact set 500"}
execute if score $ability_apply setting matches 3 run function base:merge_sign {x:"3",y:"6",z:"1",glow:"1",color:"green",trans_2:"",trans_3:"ms.ability.3",fallb_2:"◇◇◇◆◇◇",fallb_3:"仅自选双天赋",command:"trigger detect.interact set 500"}
execute if score $ability_apply setting matches 4 run function base:merge_sign {x:"3",y:"6",z:"1",glow:"1",color:"green",trans_2:"",trans_3:"ms.ability.4",fallb_2:"◇◇◇◇◆◇",fallb_3:"自选技能与一天赋",command:"trigger detect.interact set 500"}
execute if score $ability_apply setting matches 5 run function base:merge_sign {x:"3",y:"6",z:"1",glow:"1",color:"cyan",trans_2:"",trans_3:"ms.ability.5",fallb_2:"◇◇◇◇◇◆",fallb_3:"全部自选",command:"trigger detect.interact set 500"}
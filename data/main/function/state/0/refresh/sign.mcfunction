...
function base:merge_sign {x:"1",y:"1",z:"3",glow:"1",color:"yellow",trans_2:"ms.notice.regular_update",trans_3:"ms.notice.4.sign",fallb_2:"[常态更新]",fallb_3:"2.1 💠 觅于湖屿间",command:"trigger detect.interact set 4"}
...
function base:merge_sign {x:"-4",y:"11",z:"-9",glow:"1",color:"white",trans_2:"ms.credit.seayay",trans_3:"ms.credit.2.title",fallb_2:"思遥方",fallb_3:"创想家",command:"trigger detect.interact set 902"}
function base:merge_sign {x:"-6",y:"11",z:"-9",glow:"1",color:"white",trans_2:"ms.credit.yuzuki",trans_3:"ms.credit.3.title",fallb_2:"烛月yuzuki",fallb_3:"建筑师",command:"trigger detect.interact set 903"}
function base:merge_sign {x:"-8",y:"11",z:"-9",glow:"1",color:"white",trans_2:"ms.credit.translator",trans_3:"ms.credit.4.title",fallb_2:"--",fallb_3:"本地化",command:"trigger detect.interact set 904"}
...
function base:merge_sign {x:"-9",y:"11",z:"-6",glow:"1",color:"white",trans_2:"ms.credit.andyou",trans_3:"",fallb_2:"以及……",fallb_3:"",command:"trigger detect.interact set 906"}
function base:merge_sign {x:"-17",y:"11",z:"-8",glow:"1",color:"white",trans_2:"ms.credit.mol1sama",trans_3:"ms.credit.tester_sp",fallb_2:"Mol1Sama",fallb_3:"特别鸣谢",command:"trigger detect.interact set 907"}

# 地图设定
execute if score $map_page setting matches 1 if score $map setting matches 0 run function base:merge_sign {x:"-11",y:"6",z:"-8",glow:"1",color:"cyan",trans_2:"",trans_3:"ms.map.0",fallb_2:"00",fallb_3:"随机地图",command:"trigger detect.interact set 100"}
execute if score $map_page setting matches 1 unless score $map setting matches 0 run function base:merge_sign {x:"-11",y:"6",z:"-8",glow:"1",color:"white",trans_2:"",trans_3:"ms.map.0",fallb_2:"00",fallb_3:"随机地图",command:"trigger detect.interact set 100"}
execute if score $map_page setting matches 1 if score $map setting matches 1 run function base:merge_sign {x:"-11",y:"6",z:"-7",glow:"1",color:"cyan",trans_2:"",trans_3:"ms.map.1",fallb_2:"01",fallb_3:"聚光圣殿",command:"trigger detect.interact set 101"}
execute if score $map_page setting matches 1 unless score $map setting matches 1 run function base:merge_sign {x:"-11",y:"6",z:"-7",glow:"1",color:"white",trans_2:"",trans_3:"ms.map.1",fallb_2:"01",fallb_3:"聚光圣殿",command:"trigger detect.interact set 101"}
execute if score $map_page setting matches 1 if score $map setting matches 2 run function base:merge_sign {x:"-11",y:"6",z:"-6",glow:"1",color:"cyan",trans_2:"",trans_3:"ms.map.2",fallb_2:"02",fallb_3:"镇灵塔楼",command:"trigger detect.interact set 102"}
execute if score $map_page setting matches 1 unless score $map setting matches 2 run function base:merge_sign {x:"-11",y:"6",z:"-6",glow:"1",color:"white",trans_2:"",trans_3:"ms.map.2",fallb_2:"02",fallb_3:"镇灵塔楼",command:"trigger detect.interact set 102"}
execute if score $map_page setting matches 1 if score $map setting matches 3 run function base:merge_sign {x:"-11",y:"6",z:"-5",glow:"1",color:"cyan",trans_2:"",trans_3:"ms.map.3",fallb_2:"03",fallb_3:"山间湖谷",command:"trigger detect.interact set 103"}
execute if score $map_page setting matches 1 unless score $map setting matches 3 run function base:merge_sign {x:"-11",y:"6",z:"-5",glow:"1",color:"white",trans_2:"",trans_3:"ms.map.3",fallb_2:"03",fallb_3:"山间湖谷",command:"trigger detect.interact set 103"}
execute if score $map_page setting matches 1 if score $map setting matches 4 run function base:merge_sign {x:"-11",y:"6",z:"-4",glow:"1",color:"cyan",trans_2:"",trans_3:"ms.map.4",fallb_2:"04",fallb_3:"心火特区",command:"trigger detect.interact set 104"}
execute if score $map_page setting matches 1 unless score $map setting matches 4 run function base:merge_sign {x:"-11",y:"6",z:"-4",glow:"1",color:"white",trans_2:"",trans_3:"ms.map.4",fallb_2:"04",fallb_3:"心火特区",command:"trigger detect.interact set 104"}
execute if score $map_page setting matches 1 if score $map setting matches 5 run function base:merge_sign {x:"-11",y:"6",z:"-3",glow:"1",color:"cyan",trans_2:"",trans_3:"ms.map.5",fallb_2:"05",fallb_3:"昔居浮屿",command:"trigger detect.interact set 105"}
execute if score $map_page setting matches 1 unless score $map setting matches 5 run function base:merge_sign {x:"-11",y:"6",z:"-3",glow:"1",color:"white",trans_2:"",trans_3:"ms.map.5",fallb_2:"05",fallb_3:"昔居浮屿",command:"trigger detect.interact set 105"}
execute if score $map_page setting matches 1 if score $map setting matches 6 run function base:merge_sign {x:"-11",y:"6",z:"-2",glow:"1",color:"cyan",trans_2:"",trans_3:"ms.map.6",fallb_2:"06",fallb_3:"苏园夜游",command:"trigger detect.interact set 106"}
execute if score $map_page setting matches 1 unless score $map setting matches 6 run function base:merge_sign {x:"-11",y:"6",z:"-2",glow:"1",color:"white",trans_2:"",trans_3:"ms.map.6",fallb_2:"06",fallb_3:"苏园夜游",command:"trigger detect.interact set 106"}
...
# 回响禁用
function base:merge_sign {x:"-3",y:"6",z:"3",glow:"1",color:"white",trans_2:"",trans_3:"ms.setting.prev",fallb_2:"<<<",fallb_3:"上一页",command:"trigger detect.interact set 303"}
function base:merge_sign {x:"-9",y:"6",z:"3",glow:"1",color:"white",trans_2:"",trans_3:"ms.setting.next",fallb_2:">>>",fallb_3:"下一页",command:"trigger detect.interact set 304"}

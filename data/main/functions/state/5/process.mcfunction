...
# 反馈链接
execute if score $5_ending countdown matches 80 run tellraw @a[team=!admin] [{"translate":"ms.info.feedback","fallback":"反馈","color":"yellow"}," - ",{"text":"[GitHub]","color":"#7B63AB","clickEvent":{"action":"open_url","value":"https://github.com/Heart-Fire-Project/Midsoul/issues/new/choose"}}," ",{"translate":"ms.info.qq","fallback":"[QQ 群]","color":"#FFA488","clickEvent":{"action":"open_url","value":"https://qm.qq.com/cgi-bin/qm/qr?k=7lBn2CFMzpVvyAuan2Io-ifop62kNMGc&jump_from=webapi&authKey=sZcLbYxG4wtm0qq52m4D0+RTdnuHeIH3A+2qlyMClRU3mZgudXh0abRoiIR38gPj"}}," ",{"translate":"ms.info.dc","fallback":"[Discord]","color":"#0066FF","clickEvent":{"action":"open_url","value":"https://discord.com/invite/gWZVkvNS"}}," ",{"translate":"ms.info.forum","fallback":"[论坛]","color":"#FFDD55","clickEvent":{"action":"open_url","value":"https://forum.hfpro.top/"}},"\n"]

...
execute if score $start countdown matches 1..3 run playsound minecraft:entity.arrow.hit_player player @s 0 1000000 0 1000000
execute if score $start countsown matches 0 run playsound minecraft:entity.arrow.hit_player player @s 0 1000000 0 1000000 0.5

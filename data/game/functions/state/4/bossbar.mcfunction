...
execute if score $portal_count temp matches ..1 run bossbar set midsoul:info color purple
execute if score $portal_count temp matches 2.. run bossbar set midsoul:info color pink
execute if score $portal_count temp matches ..1 if score $portal_b temp matches 10.. run bossbar set midsoul:info name [{"translate":"ms.bossbar.4.portal.1","fallback":"传送门 »","color":"#BC78EC"}," ",{"score":{"objective":"temp","name":"$portal_f"}},{"text": "."},{"score":{"objective":"temp","name":"$portal_b"}}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已开启"}]
execute if score $portal_count temp matches ..1 if score $portal_b temp matches ..9 run bossbar set midsoul:info name [{"translate":"ms.bossbar.4.portal.1","fallback":"传送门 »","color":"#BC78EC"}," ",{"score":{"objective":"temp","name":"$portal_f"}},{"text": ".0"},{"score":{"objective":"temp","name":"$portal_b"}}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已开启"}]
execute if score $portal_count temp matches 2.. if score $random data matches ..1000 if score $portal_b temp matches 10.. run bossbar set midsoul:info name [{"translate":"ms.bossbar.4.portal.1","fallback":"传送门 »","color":"#FF96F9"}," ",{"score":{"objective":"temp","name":"$portal_f"}},{"text": "."},{"score":{"objective":"temp","name":"$portal_b"}}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已开启"}]
execute if score $portal_count temp matches 2.. if score $random data matches ..1000 if score $portal_b temp matches ..9 run bossbar set midsoul:info name [{"translate":"ms.bossbar.4.portal.1","fallback":"传送门 »","color":"#FF96F9"}," ",{"score":{"objective":"temp","name":"$portal_f"}},{"text": ".0"},{"score":{"objective":"temp","name":"$portal_b"}}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已开启"}]

...
execute if score $random data matches 1001.. if score $portal_b temp matches ..9 run bossbar set midsoul:info name [{"translate":"ms.bossbar.4.portal.2","fallback":"传送门 »","obfuscated":true,"color":"#FF96F9"}," ",{"score":{"objective":"temp","name":"$portal_f"},"obfuscated": false},{"text": ".0","obfuscated": false},{"score":{"objective":"temp","name":"$portal_b"},"obfuscated": false}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已开启","obfuscated":true}]
...
execute if score $random data matches ..1000 if score $portal_b temp matches ..9 run bossbar set midsoul:info name [{"translate":"ms.bossbar.4.portal.2","fallback":"传送门 »","color":"#BC78EC"}," ",{"score":{"objective":"temp","name":"$portal_f"}},{"text": ".0"},{"score":{"objective":"temp","name":"$portal_b"}}," ",{"translate":"ms.bossbar.4.portal.2","fallback":"« 已开启"}]

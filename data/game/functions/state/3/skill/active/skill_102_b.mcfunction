...
execute if score $skill_102 temp matches 1 run schedule function game:state/3/skill/active/skill_102_d 3s replace
execute if score $skill_102 temp matches 2 run schedule function game:state/3/skill/active/skill_102_d 6s replace
execute if score $skill_102 temp matches 3 run schedule function game:state/3/skill/active/skill_102_d 9s replace
execute if score $skill_102 temp matches 4 run schedule function game:state/3/skill/active/skill_102_d 12s replace
execute if score $skill_102 temp matches 5 run schedule function game:state/3/skill/active/skill_102_d 15s replace

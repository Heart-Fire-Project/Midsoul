...
scoreboard players operation @s[tag=collecting] temp /= $1000 data
scoreboard players operation @s[tag=healing] temp /= $2000 data
scoreboard players operation @s[scores={state=1},team=alive] temp /= $600 data
scoreboard players operation @s[scores={state=1},team=protect] temp /= $30 data
xp set @s 38 levels
...
xp set @s[scores={temp=64..}] 64 levels

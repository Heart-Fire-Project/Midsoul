...
scoreboard players set @a[team=alive,scores={skill=1}] skill_cd 16800
scoreboard players set @a[team=alive,scores={skill=2}] skill_cd 21600
scoreboard players set @a[team=alive,scores={skill=3}] skill_cd 14400
scoreboard players set @a[team=alive,scores={skill=4}] skill_cd 14400
scoreboard players set @a[team=protect,scores={skill=1}] skill_cd 16800
scoreboard players set @a[team=protect,scores={skill=2}] skill_cd 21600
scoreboard players set @a[team=protect,scores={skill=3}] skill_cd 14400
scoreboard players set @a[team=protect,scores={skill=4}] skill_cd 21600

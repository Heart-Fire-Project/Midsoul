...
execute if score $bossbar_anime temp matches 231..280 run bossbar set midsoul:info name {"translate":"ms.bossbar.1.ready","fallback":"游戏初始化完成 » %s 秒后开始","with":[{"score":{"objective":"countdown","name":"$game_start"}}]}

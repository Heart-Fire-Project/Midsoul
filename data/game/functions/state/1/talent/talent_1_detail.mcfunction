...
tellraw @a[team=alive,scores={talent_1=4}] {"translate":"ms.talent.004desc","fallback":" 收集到灵魂碎片时, 自身回复微量生命"}
...
tellraw @a[team=protect,scores={talent_1=4}] {"translate":"ms.talent.104desc","fallback":" 使全体灵魂陷入一段时间黑暗, 在下次攻击到灵魂前持续高亮距你较远的灵魂, 在靠近灵魂前持续隐身, 攻击到灵魂时重新开始冷却"}
# 灵魂方
tellraw @a[team=alive,scores={talent_1=1}] [" ",{"translate":"ms.talent.001.desc","fallback":"收集到灵魂碎片后, 速度小幅度提升, 收集速度略微提升"}]
...
# 守卫者方
tellraw @a[team=protect,scores={talent_1=1}] [" ",{"translate":"ms.talent.101.desc","fallback":"灵魂玩家不再显示红色警戒条"}]

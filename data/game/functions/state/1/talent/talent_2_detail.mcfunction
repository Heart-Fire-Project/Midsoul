# 灵魂方
tellraw @a[team=alive,scores={talent_2=1}] [" ",{"translate":"ms.talent.001.desc","fallback":"收集到灵魂碎片后, 速度提升, 下一次收集速度提升"}]
...
tellraw @a[team=alive,scores={talent_2=5}] [" ",{"translate":"ms.talent.005.desc","fallback":"蹲下时不会被灵魂守卫者警戒条感应到"}]

# 守卫者方
tellraw @a[team=protect,scores={talent_2=1}] [" ",{"translate":"ms.talent.101.desc","fallback":"灵魂玩家红色警戒条生效范围缩小"}]
...
tellraw @a[team=protect,scores={talent_2=5}] [" ",{"translate":"ms.talent.105.desc","fallback":"高亮距离你最远的灵魂"}]
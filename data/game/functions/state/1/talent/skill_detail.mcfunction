...
tellraw @a[team=alive,scores={skill=3}] {"translate":"ms.skill.003desc","fallback":" 即刻高亮灵魂守卫者, 灵魂守卫者距离你越近生效时间越长"}
...
tellraw @a[team=protect,scores={skill=3}] {"translate":"ms.skill.103desc","fallback":" 标记最近的灵魂, 在其移动时将会有轨迹出现"}
...
execute if score $talent_anime temp matches 40 run function game:state/1/talent/talent {"objective":"talent_1"}
execute if score $talent_anime temp matches 50 run function game:state/1/talent/talent_detail {"objective":"talent_1"}
execute if score $talent_anime temp matches 60 run function game:state/1/talent/talent {"objective":"talent_2"}
execute if score $talent_anime temp matches 70 run function game:state/1/talent/talent_detail {"objective":"talent_2"}

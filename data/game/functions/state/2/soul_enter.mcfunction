...
# 赋予状态
effect clear @s
effect give @s speed 11 2 false

# 改变模式
gamemode adventure @s

# 教学
tellraw @s[tag=!soul_played] [{"text": " » ","bold": true,"color": "aqua"},{"translate":"ms.tutorial.soul.enter","fallback": "现在你可以观察地图, 并且远离发着红光的地方……","bold": false}]
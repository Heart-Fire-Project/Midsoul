...
execute if score $map setting matches -9..-1 run tellraw @s [" ◈ ",{translate:"ms.debug.custom.shard",fallback:"碎片生成量/收集目标"}," ",{storage:"ms:temp",nbt:"shard_summon_t",color:"#50A7D9",interpret:true},"/",{storage:"ms:temp",nbt:"shard_goal_t",color:"#63C3FA",interpret:true}]
execute if score $map setting matches -9..-1 run tellraw @s [" ◈ ",{translate:"ms.debug.custom.chest",fallback:"宝盒周期刷新量/上限"}," ",{storage:"ms:temp",nbt:"chest_summon_t",color:"#CCCCCC",interpret:true},"/",{storage:"ms:temp",nbt:"chest_max_t",color:"#DEDEDE",interpret:true}]
...
execute if data storage ms:setting {random_custom:false} run tellraw @s [{translate:"ms.debug.custom.edit",fallback:"[编辑自定义地图]",click_event:{action:"run_command",command:"trigger detect.interact set -4200"}}," ",{translate:"ms.debug.random_custom",fallback:"[加入随机地图池]",color:"gray",click_event:{action:"run_command",command:"trigger detect.interact set -4201"},hover_event:{action:"show_text",value:{translate:"ms.debug.random_custom.desc",fallback:"随机地图时是否选择自定义地图"}}}]
execute if data storage ms:setting {random_custom:true} run tellraw @s [{translate:"ms.debug.custom.edit",fallback:"[编辑自定义地图]",click_event:{action:"run_command",command:"trigger detect.interact set -4200"}}," ",{translate:"ms.debug.random_custom",fallback:"[加入随机地图池]",color:"green",click_event:{action:"run_command",command:"trigger detect.interact set -4201"},hover_event:{action:"show_text",value:{translate:"ms.debug.random_custom.desc",fallback:"随机地图时是否选择自定义地图"}}}]

# 标记
tellraw @s {translate:"ms.debug.mark",fallback:"标记 »",color:"#988FF4"}
tellraw @s ["",{translate:"ms.debug.mark.blue",fallback:"[碎片]",color:"#50A7D9","click_event":{action:"run_command",command:"trigger detect.interact set -4301"}}," ",{translate:"ms.debug.mark.gold",fallback:"[灵灯]",color:"gold","click_event":{action:"run_command",command:"trigger detect.interact set -4302"}}," ",{translate:"ms.debug.mark.gray",fallback:"[宝盒]",color:"#CCCCCC","click_event":{action:"run_command",command:"trigger detect.interact set -4303"}}," ",{translate:"ms.debug.mark.purple",fallback:"[传送门]",color:"light_purple","click_event":{action:"run_command",command:"trigger detect.interact set -4304"}}," ",{translate:"ms.debug.block",fallback:"[阻断]",color:"#ECF390","click_event":{action:"run_command",command:"trigger detect.interact set -4305"}}," ",{translate:"ms.debug.mark.red",fallback:"[删除]",color:"red","click_event":{action:"run_command",command:"trigger detect.interact set -4306"}}," ",{translate:"ms.debug.lock",fallback:"[上锁]","click_event":{action:"run_command",command:"trigger detect.interact set -4307"}}," ",{translate:"ms.debug.turn",fallback:"[转向]",color:"#85C077","click_event":{action:"run_command",command:"trigger detect.interact set -4308"}}]
execute if data storage ms:setting {show_mark:false} unless score $mark_count temp matches 1 run tellraw @s ["",{translate:"ms.debug.show_mark",fallback:"[展示标记]",color:"gray","click_event":{action:"run_command",command:"trigger detect.interact set -4300"}}," ",{translate:"ms.debug.mark.invulnerable",fallback:"[实体无敌]",color:"white","click_event":{action:"run_command",command:"trigger detect.interact set -4398"}}," ",{translate:"ms.debug.mark.count",fallback:"[统计数量]",color:"white","click_event":{action:"run_command",command:"trigger detect.interact set -4399"}}]
...
execute if data storage ms:setting {show_mark:false} if score $mark_count temp matches 1 run tellraw @s ["",{translate:"ms.debug.show_mark",fallback:"[展示标记]",color:"gray","click_event":{action:"run_command",command:"trigger detect.interact set -4300"}}," ",{translate:"ms.debug.mark.invulnerable",fallback:"[实体无敌]",color:"white","click_event":{action:"run_command",command:"trigger detect.interact set -4398"}}," ",{translate:"ms.debug.mark.count",fallback:"[统计数量]",color:"white","click_event":{action:"run_command",command:"trigger detect.interact set -4399"}}," » ",{score:{objective:"temp",name:"$blue_count"},color:"#50A7D9"},"/",{score:{objective:"temp",name:"$gold_count"},color:"gold"},"/",{score:{objective:"temp",name:"$gray_count"},color:"gray"},"/",{score:{objective:"temp",name:"$purple_count"},color:"light_purple"}," + ",{score:{objective:"temp",name:"$block_count"},color:"#ECF390"}]

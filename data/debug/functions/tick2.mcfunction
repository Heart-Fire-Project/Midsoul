...
execute if score $show_mark data matches 1 run execute at @e[tag=marker_black] run particle dust 1 1 1 1.0 ~ ~0.2 ~ 0.2 0.1 0.2 0 1 force @a
...
execute if score $show_mark data matches 1 run execute at @e[tag=marker_black] run particle dust 1 1 1 1.0 ~ 70 ~ 1 0.3 1 2 10 force @a
...
execute if score $show_mark data matches 1 run execute at @e[tag=marker_black] run particle dust 1 1 1 1.0 ~ 120 ~ 1 0.3 1 0 10 force @a
...
execute as @e[tag=summon_black,type=shulker] at @s run function debug:settings/mark_black

...
scoreboard players reset $mark_count_gray temp
...
tellraw @s [{"translate":"ms.debug.mark.count.gray","fallback": " 灵魂宝物箱 » %s","color": "gray","with":[{"score":{"name":"$mark_count_gray","objective":"temp"}}]},"\n"]
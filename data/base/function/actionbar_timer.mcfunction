...
scoreboard players operation $bar temp *= #24 data
$scoreboard players operation $bar temp /= @s $(max)
$execute if score $bar temp matches 0..6 run title @s actionbar [{text:"",color:"white"},{storage:"r7s:temp",nbt:"front",color:"$(color)",interpret:true},{storage:"r7s:temp",nbt:"behind",interpret:true},"|||||||||||||||||| ",{storage:"r7s:temp",nbt:"sec",plain:true},".",{storage:"r7s:temp",nbt:"tenth",plain:true}," ||||||||||||||||||",{storage:"r7s:temp",nbt:"behind",interpret:true},{storage:"r7s:temp",nbt:"front",color:"$(color)",interpret:true}]
$execute if score $bar temp matches 7..12 run title @s actionbar [{text:"",color:"white"},{text:"||||||",color:"$(color)"},{storage:"r7s:temp",nbt:"front",color:"$(color)",interpret:true},{storage:"r7s:temp",nbt:"behind",interpret:true},"|||||||||||| ",{storage:"r7s:temp",nbt:"sec",plain:true},".",{storage:"r7s:temp",nbt:"tenth",plain:true}," ||||||||||||",{storage:"r7s:temp",nbt:"behind",interpret:true},{storage:"r7s:temp",nbt:"front",color:"$(color)",interpret:true},{text:"||||||",color:"$(color)"}]
$execute if score $bar temp matches 13..18 run title @s actionbar [{text:"",color:"white"},{text:"||||||||||||",color:"$(color)"},{storage:"r7s:temp",nbt:"front",color:"$(color)",interpret:true},{storage:"r7s:temp",nbt:"behind",interpret:true},"|||||| ",{storage:"r7s:temp",nbt:"sec",plain:true},".",{storage:"r7s:temp",nbt:"tenth",plain:true}," ||||||",{storage:"r7s:temp",nbt:"behind",interpret:true},{storage:"r7s:temp",nbt:"front",color:"$(color)",interpret:true},{text:"||||||||||||",color:"$(color)"}]
$execute if score $bar temp matches 19..24 run title @s actionbar [{text:"",color:"white"},{text:"||||||||||||||||||",color:"$(color)"},{storage:"r7s:temp",nbt:"front",color:"$(color)",interpret:true},{storage:"r7s:temp",nbt:"behind",interpret:true}," ",{storage:"r7s:temp",nbt:"sec",plain:true},".",{storage:"r7s:temp",nbt:"tenth",plain:true}," ",{storage:"r7s:temp",nbt:"behind",interpret:true},{storage:"r7s:temp",nbt:"front",color:"$(color)",interpret:true},{text:"||||||||||||||||||",color:"$(color)"}]